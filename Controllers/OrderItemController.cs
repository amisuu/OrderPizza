...
namespace RelevantPizza.Controllers
{
    public class OrderItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Type,ItemPrice")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Type,ItemPrice")] OrderItem orderItem)
        {
            if (id != orderItem.ID)
            {
                return NotFound();
